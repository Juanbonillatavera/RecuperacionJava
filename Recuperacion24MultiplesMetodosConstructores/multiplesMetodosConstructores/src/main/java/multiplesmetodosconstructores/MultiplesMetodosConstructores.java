 ...
 * @author juan bonilla
 */
public class MultiplesMetodosConstructores {
    ...
    public static void main(String[] args) {
        ...
        movie it = new movie();
        //*imprimir clase
        System.out.println(toyStory.getName() + "" + toyStory.getGenre() + "" +toyStory.getDuration()); // aqui imprimimos los resultados de la nueva clase
        System.out.println(Red.getName() + "" + Red.getGenre() + "" + Red.getDuration());
        System.out.println(it.getName() + "" + it.getGenre() + "" +it.getDuration());
    }
