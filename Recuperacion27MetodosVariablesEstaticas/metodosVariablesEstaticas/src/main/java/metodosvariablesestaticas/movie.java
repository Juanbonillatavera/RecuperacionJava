 ...
 */
public class movie {
    static final int FRAM_RESOLUTION=60; // CON ESTO PODEMOS DEFINIR ESTO COMO CONSTANTES PARA EVITAR QUE HALLA CAMBIOS INDESEADOS
    ...
    public static int getTotalFrames(int duration) { // metodo estatitico
        return duration * FRAM_RESOLUTION *SECONDS_IN_A_MINUTE;
    }
